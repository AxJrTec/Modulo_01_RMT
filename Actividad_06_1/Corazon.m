...
hxd = 16*sin(t).^3;
hyd = 10*cos(t) - 5*cos(2*t) - 2*cos(3*t) - cos(4*t) + 1;

%Velocidades de la trayectoria deseada
hxdp = 48 * (sin(t).^2) .* cos(t);
hydp = 10*sin(2*t) + 6*sin(3*t) + 4*sin(4*t) - 10*sin(t);
...
axis([-18 18 -15 13 0 1]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
