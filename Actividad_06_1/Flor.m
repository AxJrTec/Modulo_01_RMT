...
ts=0.002;            % Tiempo de muestreo en segundos (s)
...
hxdp = -50*cos(7*t) .* sin(t) - 350*sin(7*t) .* cos(t);
hydp = 50*cos(7*t) .* cos(t) - 350*sin(7*t) .* sin(t);
